...
<head>
    ...
    <!-- Styles -->
    <link rel="icon" href="{{ asset('img/chat.png') }}" type="img/x-icon">
    ...
    <!-- Sweetalert Css -->
    <link href="dashboard/plugins/sweetalert/sweetalert.css" rel="stylesheet" />
...
<body class="theme-red"> 
    ...
    <div class="search-bar">
        ...
        <form action="search" method="POST">
            <input type="text" placeholder="START TYPING..." name="search" autocomplete="off">
        </form>
    ...
    <nav class="navbar" style="background-color: teal;">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Cheer Media</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img style="margin-top: 10px;" src="{{ asset('img/'.Auth::user()->picture) }}" width="85" height="85" alt="User" />
                    <div style="float: right; margin-top: 35px; margin-left: 9px;">
                        <b>{{ Auth::user()->name }}</b> <br />
                           {{ Auth::user()->email }} 
                    </div>
                </div>
                <div class="info-container" style="margin-top: -49px">
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" style="color: black;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 - 2018 <a href="javascript:void(0);">Cheer Chat</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
    ...
    <script src="dashboard/plugins/sweetalert/sweetalert.min.js"></script>
